...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-08-2024 a las 01:53:54
...
CREATE TABLE `servicio_soldado` (
  ...
  `id_serviciol` int(10) DEFAULT NULL,
  `id_soldado1` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `cuartel_compañia`
  MODIFY `id_cuarcom` int(5) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `compañia`
  ADD CONSTRAINT `fk_idcomp` FOREIGN KEY (`id_comp1`) REFERENCES `cuartel_compañia` (`id_cuarcom`);

--
-- Filtros para la tabla `cuartel`
--
ALTER TABLE `cuartel`
  ADD CONSTRAINT `fk_idcuar` FOREIGN KEY (`id_cuar1`) REFERENCES `cuartel_compañia` (`id_cuarcom`);
...
ALTER TABLE `soldado`
  ...
  ADD CONSTRAINT `fk_idser` FOREIGN KEY (`id_serv2`) REFERENCES `servicio_soldado` (`id_sersol`),
